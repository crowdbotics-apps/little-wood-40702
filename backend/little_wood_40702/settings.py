"""
Django settings for little_wood_40702 project.
...
ROOT_URLCONF = 'little_wood_40702.urls'
...
WSGI_APPLICATION = 'little_wood_40702.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "little_wood_40702 API",
    "DESCRIPTION": "API documentation for little_wood_40702 App",
    "VERSION": "v1",
}
